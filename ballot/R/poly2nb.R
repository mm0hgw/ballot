splitCoords <- function(i.coords, j.coords, i, j) {
...
readPolyCoords <- function(sp, i) {
    do.call(rbind, lapply(sp@polygons[[i]]@Polygons, function(i.poly) i.poly@coords))
}
