...
layerTag('UK.Wm.5th',
	...
	c("Na h-Eileanan an Iar Co Const", "Ross, Skye and Lochaber Co Const", 
		...
		"Aberdeen North Burgh Const", "Orkney and Shetland Co Const", 
		"Dundee East Burgh Const", "North East Fife Co Const", "Dundee West Burgh Const", 
		"North East Fife Co Const", "Dunfermline and West Fife Co Const", 
		"Edinburgh West Burgh Const", "Arfon Co Const", "Ynys Mon Co Const", 
		"Southampton, Itchen Boro Const", "Isle of Wight Co Const",
		"Dunfermline and West Fife Co Const","Falkirk Co Const"
	),
	'NAME'
)
...
layerTag('UK.Unitary.Regions',
	...
	c( "Na h-Eileanan an Iar","Highland",
		...
		'Aberdeen City','Orkney Islands',
		'Aberdeen City','Shetland Islands',
		'Dundee City','Fife',
		'City of Edinburgh','Fife',
		'Falkirk','Fife'
	),
	'NAME'
)

layerTag('TIGER2010.KS',
	"Kansas counties from 2010",
	paste(sep="\n",
		"#'@references",
		"#' TIGER Dataset, US Census",
		"#'\\cr https://www.census.gov/geo/maps-data/data/tiger.html",
